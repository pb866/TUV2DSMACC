  SELECT CASE (jl)
    ...
    CASE(324)
      j(5001) = seval(n,theta,tmp,tmp2,b,c,d) ! CH3CH(NO3)CH2NO3 -> CH3CH(NO3)CH2O + NO2
    CASE(325)
      j(5002) = seval(n,theta,tmp,tmp2,b,c,d) ! CH3CH(NO3)CH2NO3 -> CH3CH(O.)CH2NO3 + NO2
    CASE(326)
      j(5003) = seval(n,theta,tmp,tmp2,b,c,d)*1.695 ! C2H5CH(NO3)CH2NO3 -> C2H5CH(NO3)CH2O + NO2
    CASE( 57)
